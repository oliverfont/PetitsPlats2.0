...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Fonction pour initialiser les champs de recherche avancée avec les valeurs uniques
    function initializeAdvancedSearchFields() {
        // Ajouter les options aux champs de recherche avancée
    ...
    // Fonction pour mettre à jour les champs de recherche avancée en fonction des résultats de recherche
    function updateAdvancedSearchFields(filteredRecipes) {
        // Réinitialiser les champs de recherche avancée
        resetAdvancedSearchFields();

        // Mettre à jour les champs de recherche avancée avec les valeurs uniques des recettes filtrées
        ...
        // Actualiser les options des champs de recherche avancée
        initializeAdvancedSearchFields();
    }
